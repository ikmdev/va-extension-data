        ...
        try (Stream<String> lines = Files.lines(languageFile.toPath())) {
            lines.skip(1) //skip first line, i.e. header line
                    ...
                    .forEach((data) -> {
                        ...
                        EntityProxy.Concept referencedComponent = EntityProxy.Concept.make(PublicIds.of(VaExtensionUtility.generateUUID(namespace, data[REFERENCED_COMPONENT_ID])));
                        ...
                        session.compose((SemanticAssembler semanticAssembler) -> semanticAssembler
                                ...
                                .fieldValues(fieldValues -> fieldValues
                                        .with(EntityProxy.Concept.make(PublicIds.of(VaExtensionUtility.generateUUID(namespace, data[ACCEPTABILITY_ID])))
                                )));
                    });
